  ...
  describe MistralAI::Messages::AssistantMessage do
    describe "#initialize" do
      ...
      it "raises an error when both content and tool_calls are nil" do
        expect {
          described_class.new
        }.to raise_error(ArgumentError, "Assistant message must have either content or tool_calls")
      end
      ...
      it "raises an error for invalid tool_calls format" do
        ...
        }.to raise_error(ArgumentError, "tool_calls must be an array")
      end
      ...
      it "raises an error for malformed tool_calls" do
        ...
        }.to raise_error(ArgumentError, "Invalid tool_call format")
      end
    end
  ...
  describe MistralAI::Messages::MessageBuilder do
    describe ".build" do
      ...
      it "raises an error for unknown role" do
        ...
        }.to raise_error(ArgumentError, "Unknown message role: unknown")
      end

      it "raises an error for invalid format" do
        expect {
          described_class.build("invalid")
        }.to raise_error(ArgumentError, "Invalid message format: String")
      end
    end
